...
class _Hex6ColorConverter(ColorFormatConverter):
    """A class for converting colors in hex6 representation to a canonical one."""
...
class _Hex8ColorConverter(ColorFormatConverter):
    """A class for converting colors in hex6 representation to a canonical one."""
...
class ColorConverter(ColorFormatConverter):
    ...
    _converters = {
        ...
        "hex6": _Hex6ColorConverter(),
        "hex8": _Hex8ColorConverter(),
